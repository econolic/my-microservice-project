...
# Should include:
# lesson-8-9/terraform.tfvars
# lesson-8-9/.terraform/
# lesson-8-9/terraform.tfstate*
```
...
### 1. Update Django Helm Chart with RDS Endpoint
...
# Delete bucket
aws s3 rb s3://terraform-state-budyakov-lesson8-9 --force

# Delete DynamoDB table
aws dynamodb delete-table --table-name terraform-locks-lesson8-9
```
...
- [ ] VPC with correct architecture created
